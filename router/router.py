...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(
        description='SAT-based, constrained multi-terminal routing')

    parser.add_argument('--amo-builtin-size', default=20, type=int, help='''The largest at-most-one constraint size to manually
